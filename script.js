...
function submission(event) {
  ...
  if (planChoice) {
    ...
    message.textContent = `Thank you for your interest in the ${planChoice} plan, ${name}. Unfortunately, food is a fictional company so there's no free meal to send you.`;
  } else {
    message.style.display = "block";
